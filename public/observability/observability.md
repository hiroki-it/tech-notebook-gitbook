...
既知のメトリクスとログに基づいて，システムにおける想定内の不具合の発生を未然に防ぐこと．５つの要素からなる．
...
| データの分析と報告 | データを数学的に分析し，結果を算出する．また，算出値をグラフとして報告する． |
| アラート           | データに異常がある場合，これを開発者に通知する．SLAに満たない場合，サービス利用者に利用料を返金する． |
