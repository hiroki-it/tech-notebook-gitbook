...
オブジェクト指向分析設計から派生した分析設計の手法の一つ．オブジェクト指向をより強化するために考案され，特にバックエンドに有効である．
...
クラス図の作成手順と同様に，オブジェクト図のインスタンス間の関係性を参考にして，ドメインモデル間の関係性を定義する．また，インスタンス間のリンク記号数を参考にして，多重度を付記する．クラス図との違いとして，ビジネスルール／制約を吹き出しに書き込むことにより，システムの構造だけでなくビジネスルール／制約も表現できる．ドメインモデル間のビジネスルール／制約に，データを保持する関係性がある時に，このまとまりを集約の境界として定義づけるとよい．
...
参考：https://qiita.com/little_hand_s/items/dfa4b156f533ba1a1491

![domain-model-diagram](https://raw.githubusercontent.com/hiroki-it/tech-notebook/master/images/domain-model-diagram.png)
