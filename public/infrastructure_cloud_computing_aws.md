...
| クラスターへのデータのインポート | あらかじめ作成しておいたバックアップをインポートし，これを元にRedisを構築する． | キャッシュデータを引き継ぐことができる．そのため，新しいRedisへのキャッシュデータの移行に役立つ．新しいRedisを構築する例としては，Redisのアップグレード時に，キャッシュを引き継いだアップグレード後のRedisを別途構築し，アプリケーションの向き先を古いRedisから新しいRedisに変える，といった状況がある． |
...
バックアップとインポート機能を使用して，キャッシュを引き継いだアップグレード後のRedisを別途構築する．その後，アプリケーションの向き先を古いRedisから新しいRedisに変えるようにすると，ダウンタイムを最小限にしてアップグレードできる．
